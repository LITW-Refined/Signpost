...
public class PlayerStore implements IExtendedEntityProperties {
    ...
    public void loadNBTData(NBTTagCompound compound) {
        ...
        known.remainingWaystones = compound.hasKey("leftWaystones") ? compound.getInteger("leftWaystones")
            : ClientConfigStorage.INSTANCE.getMaxWaystones();
        known.remainingSignposts = compound.hasKey("leftSignposts") ? compound.getInteger("leftSignposts")
