...
public class VillageComponentSignpost extends StructureVillagePieces.Village {
    ...
    public VillageComponentSignpost(StructureVillagePieces.Start start, int type, StructureBoundingBox boundingBox,
        int facing) {
        super(start, type);
    ...
    public static StructureVillagePieces.Village buildComponent(StructureVillagePieces.Start startPiece,
        ...
        StructureBoundingBox boundingBox = StructureBoundingBox
            .getComponentToAddBoundingBox(x, y, z, 0, 0, 0, 3, 3, 3, facing);
    ...
    public boolean addComponentParts(World world, Random random, StructureBoundingBox boundingBox) {
        ...
        int y;
        try {
            y = GenerateStructureHelper.getInstance()
                .getTopSolidOrLiquidBlock(world, x, z);
        } catch (Exception e) {
            y = this.boundingBox.getCenterY();
        }
        ...
        VillageLibrary.getInstance()
            .putSignpost(villagePos, blockPos, optimalRot(facing));
        return true;
    }
