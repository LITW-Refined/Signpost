...
public class CollectionUtils {
    ...
    public static <Key, Value> Map<Key, Value> mutateOr(Map<Key, Value> map, BiPredicate<Key, Value> condition,
        BiFunction<Key, Value, Value> mutation, BiConsumer<Key, Value> elseAction) {
