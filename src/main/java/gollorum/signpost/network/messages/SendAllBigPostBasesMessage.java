...
public class SendAllBigPostBasesMessage implements IMessage {
    ...
    public class BigStringInt {
        ...
        public BigStringInt(String string, int datInt, boolean bool, OverlayType overlay, boolean bool2,
            String[] strings, ResourceLocation paint, ResourceLocation postPaint, byte paintObjectIndex) {
            this.string = string;
            this.datInt = datInt;
            this.bool = bool;
